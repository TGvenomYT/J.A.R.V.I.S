...
class Ui_MainWindow(object):
    ...
    def update_text_browser(self, message):
        self.textBrowser_3.setTextColor(QtGui.QColor("white"))
...
if __name__ == "__main__":
    ...
    # Example usage
    ui.update_text_browser("Speaking: Hello, how can I help you?")
    ui.update_text_browser("Reply: I am here to assist you with your tasks.")
